...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (git-gutter magit flycheck company-try-hard company-fuzzy company-lsp lsp-ivy doom-themes highlight-indent-guides editorconfig exec-path-from-shell undo-tree yasnippet web-mode use-package prettier-js lsp-mode ivy-rich counsel-projectile))))
(custom-set-faces
